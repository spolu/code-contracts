class Invoice:
    """
    @cc [owner:spolu,label:product] python-invoice-fixture
    Represents a Python invoice used by the CLI integration tests.
    """

    def pay(self) -> None:
        r"""@cc [owner:spolu,label:product] python-payment-fixture
...
def report_invoices() -> None:
    """
    @cc [owner:spolu,label:product] python-report-fixture
